...
export class StateManager extends EventTarget {
    ...
    #recalculate(isNavigation = false) {
        if (!this.#state.dataA && !this.#state.dataB) {
            ...
            this.#state.diffData = DiffEngine.compare(this.#state.dataA, this.#state.dataB);
            this.#state.metadataDiffs = DiffEngine.compareMetadata(this.#state.dataA, this.#state.dataB);
        }
